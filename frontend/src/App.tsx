...
const ActaScanner = React.lazy(() => import('./pages/ActaScanner'));
const ActaAuditor = React.lazy(() => import('./pages/ActaAuditor'));
const Logout = () => {
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/acta-scanner" element={<ActaScanner />} />
      <Route path="/acta-auditor" element={<ActaAuditor />} />
