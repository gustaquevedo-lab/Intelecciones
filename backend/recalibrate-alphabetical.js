...
db.transaction(() => {
    for (let i = 0; i < locals.length; i++) {
        ...
        const electores = db.prepare('SELECT ci FROM electors WHERE local_votacion = ? ORDER BY apellido ASC, nombre ASC, ci ASC').all(loc);
...
//# sourceMappingURL=recalibrate-alphabetical.js.map